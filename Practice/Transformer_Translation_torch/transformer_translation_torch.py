...
# @Time    : 2022/3/3 19:05
# @Author  : Zhang Jiaqi
# @File    : transformer_translation_torch.py
# @Description: 基于Transformer的英语-法语翻译
import os.path
# from d2l.torch import nn
from torch import nn
from d2l.torch import DATA_URL, DATA_HUB, download_extract
from d2l.torch import Vocab
from d2l.torch import try_gpu
from d2l.torch import load_array
from d2l.torch import tensor, reduce_sum, astype, int32
from utils.transformer_encoder import TransformerEncoder
from utils.transformer_decoder import TransformerDecoder
from d2l.torch import train_seq2seq, predict_seq2seq, bleu
...
def build_array_nmt(lines, vocab, num_steps):
    ...
    array = tensor([truncate_pad(l, num_steps, vocab['<pad>']) for l in lines])
